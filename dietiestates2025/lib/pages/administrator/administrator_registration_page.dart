...
import 'administrator_home_page.dart';

class AdministratorRegistrationPage extends StatefulWidget {
  const AdministratorRegistrationPage({super.key});

  @override
  _AdministratorRegistrationPageState createState() =>
...
class _AdministratorRegistrationPageState
  ...
  // Funzione per registrare l'amministratore
  Future<void> _registerAdministrator() async {
    ...
    try {
      await _utenteRepository.createUtente(newAdmin);
      _showSuccessDialog('Registrazione del gestore avvenuta con successo!');
      _clearFields();
    } catch (e) {
      _showErrorDialog(
          'Errore durante la registrazione: L\'amministratore è già registrato.');
    } finally {
      setState(() => _isLoading = false);
    }
  }
            ...
            CupertinoDialogAction(
              ...
              onPressed: () {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => AdministratorInfoPage()),
                ); // Naviga alla pagina AdministratorInfoPage
              },
        ...
        suffixIcon: isPassword
          ...
          icon: Icon(
            ...
            color: _isPasswordVisible
                ...
                : const Color(0xFF0079BB), // Colore arancio per visibile
          ),
          onPressed: () {
            setState(() {
  ...
  Widget _buildRegisterButton() {
    return _isLoading
        ...
        : ElevatedButton(
      onPressed: _registerAdministrator,
